...
class User(db.Model):
    ...
    userlogs = db.relationship('Userlog', backref='user')  # 会员日志外健关系关联
    comments = db.realtionship('Comment', backref='user')  # 评论外键关系关联
...
class Role(db.Model):
    ...
    admins = db.relationship('Admin', backhrf='role')  # 管理员外键关系关联
...
class Admin(db.Model):
    ...
    adminlogs = db.relationship('Adminlog', backhrf='admin')  # 管理员登录日志外键关系关联
    oplogs = db.relationship('Oplog', backhrf='admin')  # 管理员操作日志外键关系关联
